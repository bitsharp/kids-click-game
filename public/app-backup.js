(function(){
  ...
  function addCoins(n){ balance += n; totalEarned += n; save(); renderBalance(); animateAdd(n); coinSound(); checkMilestone1000(); checkMilestone2000(); }
  ...
  async function attemptBuy(item){
    ...
    try{
      ...
      if (data && data.success){
        buttonClickSound();
        balance -= item.price; save(); renderBalance(); successSound(); showToast('Purchase successful!'); applyItem(item); renderItems();
      } else {
